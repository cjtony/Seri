...
namespace Payroll.Controllers
{
    public class SaveDataGeneralController : Controller
    {
        ...
        [HttpPost]
        public JsonResult DataNomina(string fecefecnom, double salmen, int tipemp, int nivemp, int tipjor, int tipcon, string fecing, string fecant, string vencon, string empleado, string apepat, string apemat, string fechanaci, int tipper, int tipcontra, int tippag, int banuse, string cunuse, int position, int clvemp, int tiposueldo, int politica, double diferencia, double transporte, int retroactivo, Boolean flagSal, string motMoviSal, string fechMoviSal, double salmenact, int categoria, int pagopor, int fondo, double ultSdi, int clasif, int prestaciones)
        {
            Boolean flag         = false;
            String  messageError = "none";
        ...
        public JsonResult SaveUltSdi(int clvNom, double ultSdi, int keyEmployee)
        {
            ...
            try {
                ...
                datosNominaBean = datosNominaDao.sp_Actualiza_Ult_Sdi(clvNom, ultSdi, keyBusiness, keyEmployee);
