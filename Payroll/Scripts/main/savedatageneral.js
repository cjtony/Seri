$(function () {
    ...
    fsavedatanomina = () => {
        ...
        const dataSend = {
            ...
            diferencia: diferencia.value, transporte: transporte.value, retroactivo: retroactivoSend, flagSal: false, motMoviSal: "none", fechMoviSal: "none", salmenact: 0.00, categoria: categoriaEm.value, pagopor: pagoPorEmpl.value, fondo: conFondoSend, ultSdi: parseFloat(ultSdi.value)
        };
